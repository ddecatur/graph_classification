...
def series_classification (path_to_data, n):
    ...
    if(cwd!=path_to_data):
        ...
        train_2_dir = os.path.join(train_dir, '2')  # directory with our training negative pictures
        train_3_dir = os.path.join(train_dir, '3')  # directory with our training neutral pictures
        validation_1_dir = os.path.join(validation_dir, '1')  # directory with our validation positive pictures
        validation_2_dir = os.path.join(validation_dir, '2')  # directory with our validation negative pictures
        validation_3_dir = os.path.join(validation_dir, '3')  # directory with our validation neutral pictures
